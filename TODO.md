...
- [x] T595: Version bump to v2.70.0 — 158 suites, ~2340 tests. 100% coverage all event types + helpers. (PR #506)
- [ ] T596: Project health — archive completed TODOs, perf profiling, cleanup stale handoffs.
