...
run_mod() {
  ...
  local out
  out=$(CLAUDE_PROJECT_DIR="C:/Users/joelg/Documents/ProjectsCL1/hook-runner" \
    node -e "
      var mod = require('./$MOD');
...
R=$(run_mod Edit file_path "C:/Users/joelg/Documents/ProjectsCL1/hook-runner/setup.js")
assert "same-project Edit passes" "pass" "$R"

# Test: cross-project access → block
R=$(run_mod Edit file_path "C:/Users/joelg/Documents/ProjectsCL1/other-project/index.js")
assert "cross-project Edit blocks" "block" "$R"

# Test: cross-project Read → block
R=$(run_mod Read file_path "C:/Users/joelg/Documents/ProjectsCL1/other-project/foo.txt")
assert "cross-project Read blocks" "block" "$R"

# Test: cross-project Bash cd → block
R=$(CLAUDE_PROJECT_DIR="C:/Users/joelg/Documents/ProjectsCL1/hook-runner" \
  node -e "
    var mod = require('./$MOD');
    var r = mod({tool_name:'Bash',tool_input:{command:'cd C:/Users/joelg/Documents/ProjectsCL1/other-project && ls'}});
    console.log(r && r.decision === 'block' ? 'block' : 'pass');
  " 2>/dev/null) || true
assert "cross-project Bash cd blocks" "block" "$R"

# Test: TODO.md write to other project → pass (allowed exception)
R=$(run_mod Write file_path "C:/Users/joelg/Documents/ProjectsCL1/other-project/TODO.md")
assert "cross-project TODO.md write passes" "pass" "$R"

# Test: SESSION_STATE.md write → pass (allowed exception)
R=$(run_mod Write file_path "C:/Users/joelg/Documents/ProjectsCL1/other-project/SESSION_STATE.md")
...
R=$(CLAUDE_PROJECT_DIR="C:/Users/joelg/Documents/ProjectsCL1/hook-runner" \
  node -e "
    var mod = require('./$MOD');
    var r = mod({tool_name:'Bash',tool_input:{command:'python C:/Users/joelg/Documents/ProjectsCL1/context-reset/context_reset.py --project-dir /foo'}});
    console.log(r && r.decision === 'block' ? 'block' : 'pass');
  " 2>/dev/null) || true
...
R=$(run_mod Edit file_path "C:/Users/joelg/.claude/skills/some-other-skill/SKILL.md")
